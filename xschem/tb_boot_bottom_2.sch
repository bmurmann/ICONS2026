...
N 280 -440 300 -440 {lab=#net3}
N 280 -460 280 -440 {lab=#net3}
N 280 -460 460 -480 {lab=#net3}
N 460 -520 460 -480 {lab=#net3}
N 420 -520 460 -520 {lab=#net3}
N 460 -520 520 -520 {lab=#net3}
N 460 -420 520 -420 {lab=#net2}
N 200 -540 300 -540 {lab=trackb}
N 200 -540 200 -520 {lab=trackb}
N 200 -400 300 -400 {lab=track}
N 200 -440 200 -400 {lab=track}
...
N 160 -400 200 -400 {lab=track}
N 30 -400 100 -400 {lab=#net4}
N 30 -400 30 -380 {lab=#net4}
...
.control
    ...
    foreach i $&bin_vec
      ...
      let lin-tstart = 1.9n
      linearize
      wrdata tb_boot_bottom_2.txt v(vi) v(vo)
      destroy all
      set appendwrite
      unset wr_vecnames
    end
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_boot_bottom_2.raw tran"
}
...
C {devices/lab_wire.sym} 250 -400 0 0 {name=p30 sig_type=std_logic lab=track}
C {devices/lab_wire.sym} 250 -540 0 0 {name=p31 sig_type=std_logic lab=trackb}
C {devices/lab_wire.sym} 600 -420 2 0 {name=p32 sig_type=std_logic lab=p1}
C {devices/lab_wire.sym} 600 -520 2 0 {name=p33 sig_type=std_logic lab=p2}
C {sg13g2_stdcells/sg13g2_inv_4.sym} 560 -520 0 0 {name=x1 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_inv_4.sym} 560 -420 0 0 {name=x2 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_nand2_2.sym} 360 -520 0 0 {name=x3 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_nand2_2.sym} 360 -420 0 0 {name=x4 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_stdcells/sg13g2_inv_2.sym} 200 -480 3 0 {name=x5 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {vsource.sym} 30 -355 0 0 {name=Vtrk value="pulse(0 vdd 0 trf trf \{per/2\} per 0)" savecurrent=false}
C {devices/gnd.sym} 30 -325 0 0 {name=l10 lab=GND}
...
C {boot2.sym} 830 -320 0 0 {name=x6}
