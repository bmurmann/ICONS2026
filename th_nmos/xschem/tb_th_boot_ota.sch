...
logy=0
sim_type=tran
rawfile=./simulation/tb_th_boot_ota.raw
autoload=1
hilight_wave=-1
y2=0.43
color="7 21"
...
.control
    ...
    foreach i $&bin_vec
      ...
      wrdata tb_th_boot_ota.txt v(vop) 
      set appendwrite
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_th_boot_ota.raw tran"
}
C {vsource.sym} 130 -190 0 0 {name=Vdm value="sin(0 vamp fin 0)" savecurrent=false}
C {th_boot_ota.sym} 720 -460 0 0 {name=x1}
