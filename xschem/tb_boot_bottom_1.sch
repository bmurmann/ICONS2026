...
.control
    ...
    foreach i $&bin_vec
      ...
      let lin-tstart = 1.9n
      linearize
      wrdata tb_boot_bottom_1.txt v(vi) v(vo)
      destroy all
      set appendwrite
      unset wr_vecnames
    end
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_boot_bottom_1.raw tran"
}
...
C {boot1.sym} 830 -320 0 0 {name=x6}
