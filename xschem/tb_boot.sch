...
S {}
E {}
B 2 460 -1010 950 -660 {flags=graph
y1=0.13
ypos1=0
ypos2=2
divy=5
...
logy=0
sim_type=tran
rawfile=./simulation/tb_boot.raw
autoload=1
hilight_wave=1
y2=0.5
color=7
...
N 810 -360 890 -360 {lab=vo}
N 890 -360 890 -250 {lab=vo}
...
C {devices/code_shown.sym} 1020 -950 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false
value="
...
C {launcher.sym} 200 -850 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_boot.raw tran"
}
...
footprint=1206
device="ceramic capacitor"}
C {devices/gnd.sym} 890 -190 0 0 {name=l12 lab=GND}
C {capa.sym} 890 -220 0 0 {name=C6
m=1
value=cl
footprint=1206
device="ceramic capacitor"}
...
C {devices/lab_wire.sym} 890 -360 0 1 {name=p1 sig_type=std_logic lab=vo}
...
C {vsource.sym} -290 -320 0 0 {name=Vtrk value="pulse(0 vdd 0 trf trf \{per/2\} per 0)" savecurrent=false}
C {devices/gnd.sym} -290 -290 0 0 {name=l10 lab=GND}
