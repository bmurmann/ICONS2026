...
N 600 -110 650 -110 {lab=track_res}
N 810 -230 870 -230 {lab=#net2}
N 810 -130 870 -130 {lab=#net1}
N -160 -340 -160 -270 {lab=vss}
N -130 -340 -80 -340 {lab=#net3}
N -80 -340 -80 -290 {lab=#net3}
N -210 -290 -80 -290 {lab=#net3}
N -210 -340 -210 -290 {lab=#net3}
N -210 -340 -190 -340 {lab=#net3}
N -80 -370 -80 -340 {lab=#net3}
N -80 -290 -80 -260 {lab=#net3}
N -80 -200 -80 -160 {lab=vss}
N -160 -450 -160 -380 {lab=#net4}
N -80 -450 -80 -430 {lab=#net4}
N -160 -450 -80 -450 {lab=#net4}
N 610 -380 650 -380 {lab=vip}
N 950 -230 1020 -230 {lab=ph}
N 950 -130 1020 -130 {lab=pt}
N 1010 -370 1010 -340 {lab=vss}
N 940 -400 970 -400 {lab=track_res}
...
N 710 -750 750 -750 {lab=vgp}
N 710 -750 710 -600 {lab=vgp}
N 630 -600 710 -600 {lab=vgp}
N 80 -540 150 -540 {lab=track_res}
N 260 -270 340 -270 {lab=vom}
N 110 -270 200 -270 {lab=vim}
...
C {ipin.sym} 20 -540 0 0 {name=p7 lab=track}
...
C {devices/lab_wire.sym} 120 -540 0 0 {name=p24 sig_type=std_logic lab=track_res}
...
C {devices/lab_wire.sym} 600 -110 0 0 {name=p30 sig_type=std_logic lab=track_res}
...
C {devices/lab_wire.sym} -160 -270 2 1 {name=p34 sig_type=std_logic lab=vss}
C {vsource.sym} -80 -230 0 0 {name=V1 value=vcm savecurrent=false}
C {vsource.sym} -80 -400 0 0 {name=V2 value=vdd savecurrent=false}
C {devices/lab_wire.sym} -80 -160 2 1 {name=p35 sig_type=std_logic lab=vss}
C {devices/lab_wire.sym} 700 -500 2 1 {name=p9 sig_type=std_logic lab=vss}
...
C {devices/lab_wire.sym} 940 -400 0 0 {name=p40 sig_type=std_logic lab=track_res}
...
C {sg13g2_inv_2.sym} 910 -230 0 0 {name=x6 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_inv_2.sym} 910 -130 0 0 {name=x4 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_inv_2.sym} 190 -540 0 0 {name=x1 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_nand2_2.sym} 710 -230 0 0 {name=x5 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13g2_nand2_2.sym} 710 -130 0 0 {name=x2 VDD=VDD VSS=VSS prefix=sg13g2_ }
C {sg13_lv_nmos.sym} -160 -360 3 1 {name=mdum
l=\{l\}
w=\{w/nf\}
ng=1
m=nf
...
C {devices/capa.sym} 780 -750 3 0 {name=Cp4
m=1
value=100f
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} 810 -750 2 0 {name=p50 sig_type=std_logic lab=vss}
C {res.sym} 50 -540 1 0 {name=R1
value=1
footprint=1206
device=resistor
m=1}
C {switch_ngspice.sym} 720 -460 1 0 {name=S9 model=SW1
device_model=".MODEL SW1 SW 
+ VT=0.6 VH=vh
+ RON=10 ROFF=10G"}
C {res.sym} 230 -270 1 0 {name=R2
value=10
footprint=1206
device=resistor
m=1}
